<?php
/**
 * File for ColissimoAFWsdlClass to communicate with SOAP service
 * @package ColissimoAF
 ...
 */
/**
 * ColissimoAFWsdlClass to communicate with SOAP service
 * 
 * @package ColissimoAF
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2018-10-26
 */
class ColissimoAFWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://ws.Colissimo.fr/sls-ws/SlsServiceWS?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses ColissimoAFWsdlClass::setLastError()
     * @uses ColissimoAFWsdlClass::initSoapClient()
     * @uses ColissimoAFWsdlClass::initInternArrayToIterate()
     * @uses ColissimoAFWsdlClass::_set()
     ...
     * @return ColissimoAFWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'ColissimoAFWsdlClass'))
            {
     ...
     * @uses ColissimoAFClassMap::classMap()
     * @uses ColissimoAFWsdlClass::getDefaultWsdlOptions()
     * @uses ColissimoAFWsdlClass::getSoapClientClassName()
     * @uses ColissimoAFWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('ColissimoAFClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = ColissimoAFClassMap::classMap();
     ...
     * If a class is named as {ColissimoAF}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('ColissimoAFSoapClient') && is_subclass_of('ColissimoAFSoapClient','SoapClient'))
            return 'ColissimoAFSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses ColissimoAFWsdlClass::WSDL_CACHE_WSDL
     * @uses ColissimoAFWsdlClass::WSDL_COMPRESSION
     * @uses ColissimoAFWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses ColissimoAFWsdlClass::WSDL_ENCODING
     * @uses ColissimoAFWsdlClass::WSDL_EXCEPTIONS
     * @uses ColissimoAFWsdlClass::WSDL_FEATURES
     * @uses ColissimoAFWsdlClass::WSDL_LOGIN
     * @uses ColissimoAFWsdlClass::WSDL_PASSWORD
     * @uses ColissimoAFWsdlClass::WSDL_SOAP_VERSION
     * @uses ColissimoAFWsdlClass::WSDL_STREAM_CONTEXT
     * @uses ColissimoAFWsdlClass::WSDL_TRACE
     * @uses ColissimoAFWsdlClass::WSDL_TYPEMAP
     * @uses ColissimoAFWsdlClass::WSDL_URL
     * @uses ColissimoAFWsdlClass::VALUE_WSDL_URL
     * @uses ColissimoAFWsdlClass::WSDL_USER_AGENT
     * @uses ColissimoAFWsdlClass::WSDL_PROXY_HOST
     * @uses ColissimoAFWsdlClass::WSDL_PROXY_PORT
     * @uses ColissimoAFWsdlClass::WSDL_PROXY_LOGIN
     * @uses ColissimoAFWsdlClass::WSDL_PROXY_PASSWORD
     * @uses ColissimoAFWsdlClass::WSDL_LOCAL_CERT
     * @uses ColissimoAFWsdlClass::WSDL_PASSPHRASE
     * @uses ColissimoAFWsdlClass::WSDL_AUTHENTICATION
     * @uses ColissimoAFWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses ColissimoAFWsdlClass::getSoapClient()
     * @uses ColissimoAFWsdlClass::getFormatedXml()
     ...
     * @uses ColissimoAFWsdlClass::getSoapClient()
     * @uses ColissimoAFWsdlClass::convertStringHeadersToArray()
     ...
     * @uses ColissimoAFWsdlClass::count()
     * @return int
     */
     ...
     * @uses ColissimoAFWsdlClass::getInternArrayToIterate()
     * @uses ColissimoAFWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses ColissimoAFWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses ColissimoAFWsdlClass::getInternArrayToIterateOffset()
     * @uses ColissimoAFWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses ColissimoAFWsdlClass::getInternArrayToIterateOffset()
     * @uses ColissimoAFWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see ColissimoAFWsdlClass::offsetGet()
     * @uses ColissimoAFWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses ColissimoAFWsdlClass::getAttributeName()
     * @uses ColissimoAFWsdlClass::__toString()
     * @uses ColissimoAFWsdlClass::_set()
     * @uses ColissimoAFWsdlClass::_get()
     * @uses ColissimoAFWsdlClass::setInternArrayToIterate()
     * @uses ColissimoAFWsdlClass::setInternArrayToIterateIsArray()
     * @uses ColissimoAFWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses ColissimoAFWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses ColissimoAFWsdlClass::item()
     * @uses ColissimoAFWsdlClass::length()
     * @return mixed
     */
