<?php
/**
 * File for class ColissimoPRStructFindRDVPointRetraitAcheminement
 * @package ColissimoPR
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ColissimoPRStructFindRDVPointRetraitAcheminement originally named findRDVPointRetraitAcheminement
 ...
 * @date 2018-10-26
 */
class ColissimoPRStructFindRDVPointRetraitAcheminement extends ColissimoPRWsdlClass
{
    /**
     * The accountNumber
     * Meta informations extracted from the WSDL
     ...
     * @return ColissimoPRStructFindRDVPointRetraitAcheminement
     */
    public function __construct($_accountNumber = NULL,$_password = NULL,$_apikey = NULL,$_codTiersPourPartenaire = NULL,$_address = NULL,$_zipCode = NULL,$_city = NULL,$_countryCode = NULL,$_weight = NULL,$_shippingDate = NULL,$_filterRelay = NULL,$_requestId = NULL,$_lang = NULL,$_optionInter = NULL)
    {
        parent::__construct(array('accountNumber'=>$_accountNumber,'password'=>$_password,'apikey'=>$_apikey,'codTiersPourPartenaire'=>$_codTiersPourPartenaire,'address'=>$_address,'zipCode'=>$_zipCode,'city'=>$_city,'countryCode'=>$_countryCode,'weight'=>$_weight,'shippingDate'=>$_shippingDate,'filterRelay'=>$_filterRelay,'requestId'=>$_requestId,'lang'=>$_lang,'optionInter'=>$_optionInter),false);
    }
    /**
