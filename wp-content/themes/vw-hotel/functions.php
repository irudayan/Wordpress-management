...
function vw_hotel_activation_notice() {
	...
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_hotel_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-hotel' ) .'</a></p>';
	echo '</div>';
}
...
function vw_hotel_scripts() {
	...
	wp_enqueue_style( 'vw-hotel-effect', esc_url(get_template_directory_uri()).'/css/effect.css' );
	...
	wp_enqueue_script( 'vw-hotel-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/js/custom.js', array('jquery') );
...
//define
define('VW_HOTEL_FREE_THEME_DOC',__('https://vwthemesdemo.com/docs/free-vw-hotel/','vw-hotel'));
...
define('VW_HOTEL_BUY_NOW',__('https://www.vwthemes.com/themes/wordpress-hotel-theme/','vw-hotel'));
define('VW_HOTEL_LIVE_DEMO',__('https://www.vwthemes.net/vw-hotel-pro/','vw-hotel'));
define('VW_HOTEL_PRO_DOC',__('https://vwthemesdemo.com/docs/vw-hotel-pro/','vw-hotel'));
...
define('VW_HOTEL_CREDIT',__('https://www.vwthemes.com/themes/free-wordpress-hotel-theme/','vw-hotel'));
